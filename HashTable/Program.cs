...
namespace HashTable
{
    class Program
    {
        ...
        {
            HashTableChainedTester.Testing(HashFuncType.Div, HashFuncType.Multi, HashFuncType.SHA256,
                HashFuncType.HMACMD5, HashFuncType.XXHash32, HashFuncType.MurmurHash);
